...
def test_changepass_wrong_password(user_client, init_database):
    """
    GIVEN a Flask app configured for testing
    WHEN the '/changepass' page is requested (POST) with incorrect password
    THEN error message is displayed
    """
    response = user_client.post(url_for('basic.changepass'), data={
            "old_pass": "incorrect",
            "new_pass": "whatever",
...
def test_changepass_new_password_not_identical(user_client, init_database):
    """
    GIVEN a Flask app configured for testing
...
def test_changepass_correct(user_client, init_database):
    """
    GIVEN a Flask app configured for testing
